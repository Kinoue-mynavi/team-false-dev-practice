...
from flask_app.models.functions.ticket import read_ticket_event_id, read_ticket_one
...
def confirm_cancel():
    if session["logged_in_customer"] == True:
        ...
        customer_payment = customer_info["customer_info.payment"]
